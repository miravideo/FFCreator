...
class FFTransition extends FFClip {
  ...
  refresh(delta) {
    ...
    if (!this.parent) {
      ...
      this.prevSibling = this.prevRefId && this.prevRefId != this.refId ? 
                          this.root().getByRefId(this.prevRefId) : null;
      if (this.prevSibling) this.prevSibling.nextSibling = this;
      this.nextSibling = this.nextRefId && this.nextRefId != this.refId ? 
                          this.root().getByRefId(this.nextRefId) : null;
      if (this.nextSibling) this.nextSibling.prevSibling = this;
    }
  }
