...
class FFText extends FFNode {
  ...
  updateStyle() {
    const { width, fontSize, color, stroke, strokeThickness, backgroundColor, wrap, align, lineHeight } = this;
    const fontFamily = this.font?.fontFamily;
    const style = {
      fontFamily, fontSize, color, stroke, strokeThickness, backgroundColor, align, lineHeight,
